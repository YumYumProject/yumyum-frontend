...
const Sample = () => {
  return (
    <div className="p-[80px]">
      <div className="max-w-[1440px] mx-auto px-[16px] flex flex-col justify-center items-center backdrop-blur-sm">
        <div className="contianer-menu relative box-border w-[990px] h-[860px] flex justify-center mb-[20px]">
          <img className="w-full h-[660px] rounded-2xl" src="/assets/img/img-spaghetti-carbonara.jpg" alt="img-menu" />

          <div className="absolute bottom-0 rounded-t-2xl bg-white w-[700px] h-[250px] px-[60px] pt-[60px] mt-auto mx-[145px] flex flex-col items-center">
            <div className="block w-full text-orange">
              <p className="max-h-[130px] font-black text-[58px] text-center text-ellipsis overflow-hidden leading-[60px]">
                สปาเกตตี้คาโบนาร่าาาาาาาาาาาาาาาาาาาาาาาาาาาาาาาาาาาาาา
              </p>
        ...
        <hr className="w-full border-2 mb-[50px] border-orange" />
        <div className="flex justify-center gx-[20px]">
          <div className="w-1/2]">
            ...
            <ul className="list-decimal">
              <li>
                ...
                <label htmlFor="material">เส้นสปาเก็ตตี้ 100 กรัม</label>
              </li>
          ...
          <div className="w-1/2 pl-10">
            ...
            <ol className="list-decimal list-border-bg-black">
              <li className=" border border-bg-orange">นำเบคอนมาหั่นเป็นชิ้นขนาดตามต้อมการ</li>
              <li>นำไข่ไก่สดมาแยกไข่แดงออกจากไข่ขาว โดยใช้เฉพาะไข่แดงอย่างเดียว 3 ฟอง และไข่ไก่ทั้งใบ 1 ฟอง</li>
              <li>นำพาเมซานชีสที่ขูดแล้วมาผสมกับไข่ไก่ จากนั้นใส่พริกไทย และเกลือ คนผสมให้เข้ากัน</li>
              <li>ต้มน้ำให้เดือด แล้วใส่เกลือลงไป จากนั้นใส่เส้นสปาเก็ตตี้ลงไปต้ม ใช้เวลาต้มประมาณ 6 นาที</li>
              <li>
                นำเบคอนมาผัดในกระทะจนเหลืองหอม และเริ่มมีน้ำมันออกมา จากนั้นใส่เส้นสปาก็ตตี้ที่ต้มเสร็จแล้วลงไป
                ผัดจนน้ำมันเบคอนเคลือบเส้นดี เติมน้ำเดือดที่ใช้ต้มเส้นลงไปเล็กน้อย
              </li>
              <li>ปิดเตาแก๊ส จากนั้นใส่ส่วนผสมของไข่และชีสลงไป แล้วคลุกเคล้าให้เข้ากับเส้นสปาเก็ตตี้</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    //     <div className="menu-list w-full h-auto grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 justify-items-center box-content gap-x-10 gap-y-16 py-[60px] border-2 rounded-3xl">
